...
use App\ToolsBundle\Repositories\Scenario\Scenarious\PublicToPublicScenario;
...
class PublicToPublicCondition extends GenericCondition implements ConditionInterface
{
    ...
    public function createScenario() {
        return new PublicToPublicScenario($this->scenarioData);
    }
} 