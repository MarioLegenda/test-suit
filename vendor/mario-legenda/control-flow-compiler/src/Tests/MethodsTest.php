...
class MethodsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMethodFactory() {
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\VoidMethod', $method, 'testMethodFactory(): MethodFactory::createMethod() has to return VoidMethod');
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\ReturnsTrueMethod', $method, 'testMethodFactory(): MethodFactory::createMethod() has to return RetrunsTrueMethod');
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\ReturnsObjectMethod', $method, 'testMethodFactory(): MethodFactory::createMethod() has to return ReturnsObjectMethod');
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\ReturnsSelfMethod', $method, 'testMethodFactory(): MethodFactory::createMethod() has to return ReturnsSelfMethod');
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\ReturnsFalseMethod', $method, 'testMethodFactory(): MethodFactory::createMethod() has to return ReturnsFalseMethod');
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\ReturnsArrayMethod', $method, 'testMethodFactory(): MethodFactory::createMethod() has to return ReturnsArrayMethod');
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\ReturnsStringMethod', $method, 'testMethodFactory(): MethodFactory::createMethod() has to return ReturnsStringMethod');
    }
    ...
    public function testVoidMethod() {
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\VoidMethod', $method, 'testVoidMethod(): MethodFactory::createMethod() has to return VoidMethod');
    ...
    public function testStringMethod() {
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\ReturnsStringMethod', $method, 'testStringMethod(): MethodFactory::createMethod() has to return ReturnsStringMethod');
    ...
    public function testTrueMethod() {
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\ReturnsTrueMethod', $method, 'testTrueMethod(): MethodFactory::createMethod() has to return ReturnsTrueMethod');
    ...
    public function testFalseMethod() {
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\ReturnsFalseMethod', $method, 'testFalseMethod(): MethodFactory::createMethod() has to return ReturnsFalseMethod');
    ...
    public function testArrayMethod() {
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\ReturnsArrayMethod', $method, 'testArrayMethod(): MethodFactory::createMethod() has to return ReturnsArrayMethod');
    ...
    public function testObjectMethod() {
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\ReturnsObjectMethod', $method, 'testObjectMethod(): MethodFactory::createMethod() has to return ReturnsObjectMethod');
    ...
    public function testSelfMethod() {
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\ReturnsSelfMethod', $method, 'testSelfMethod(): MethodFactory::createMethod() has to return ReturnsSelfMethod');
        $company = new \Company();
        $returned = $method->execute($company)->checkReturned();
