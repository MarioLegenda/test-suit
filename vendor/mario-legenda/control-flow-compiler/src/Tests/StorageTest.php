...
class StorageTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testObjectStorage() {
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\MethodTypes\\ReturnedValue', $returned,
        ...
        $this->assertInstanceOf('ControlFlowCompiler\\Storage\\StorageUnit', $objectStorage->retreiveUnit($company),
